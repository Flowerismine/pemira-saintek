        ...
        <>
          ...
          {viewLevel === 'ROOT' && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in mt-8">
              <button onClick={() => handleLevel1Click('DEMA-F')} className="glass-panel p-8 text-left hover:border-primary-300 hover:shadow-lg transition-all group">
                <div className="w-14 h-14 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <Shield size={28} />
                </div>
                <h2 className="text-xl font-bold text-slate-900 mb-2">DEMA Fakultas (DEMA-F)</h2>
